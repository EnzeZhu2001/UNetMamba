...
classes = CLASSES
image_size = 1024
crop_size = int(768*float(image_size/1024))
...
pretrained_ckpt_path = 'pretrain_weights/vssm_tiny_0230_ckpt_epoch_262.pth' # the path for the pretrained unetmamba weight
...
train_dataset = PotsdamDataset(data_root='data/potsdam/train_'+str(image_size), mode='train',
                               mosaic_ratio=0.25, transform=train_aug)

val_dataset = PotsdamDataset(transform=val_aug)
test_dataset = PotsdamDataset(data_root='data/potsdam/test_'+str(image_size),
                              transform=val_aug)
