...
if True:
    draw_fig([
        ...
        dict(x=deit_small[1], y=deit_small[2], label="deit_small (equal to tiny unetmamba)"),
        dict(x=resnet50[1], y=resnet50[2], label="resnet50 (equal to tiny unetmamba)"),
        dict(x=vssm_tiny[1], y=vssm_tiny[2], label="vssm_tiny"),
        dict(x=replknet_31B[1], y=replknet_31B[2], label="replknet_31B (equal to *base unetmamba, 1024 is too big to test)"),
