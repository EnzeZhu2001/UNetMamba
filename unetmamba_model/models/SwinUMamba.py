...
from unetmamba_model.mamba_ssm.ops.selective_scan_interface import selective_scan_fn, selective_scan_ref
...
class VSSMEncoder(nn.Module):
    ...
    def _init_weights(self, m: nn.Module):
        ...
        no fc.weight found in the any of the unetmamba parameters
        no nn.Embedding found in the any of the unetmamba parameters
...
def load_pretrained_ckpt(
    ...
    for k, v in ckpt['unetmamba'].items():
        if k in skip_params:
...
#     hidden_size=768,
# )
# unetmamba = load_pretrained_ckpt(unetmamba)

# params = 0
# for name, param in unetmamba.named_parameters():
#     params += param.nelement()
# print(params)

# data = torch.randn(2,3,256,256).to("cuda")
# print(unetmamba(data).shape)